...
const featuredProjects = [
  {
    ...
    description:
      "A full-stack MERN e-commerce platform featuring JWT authentication, product management, shopping cart, Stripe payment integration, order tracking, and a complete admin dashboard. Built with React, Node.js, Express, and MongoDB.",
    image: "/images/ecommerce.png",
    tags: ["Next.js", "Stripe", "Firebase", "Redux"],
    github: "https://github.com/usman684/mern-ecommerce-pro",
    live: "https://shopwave-frontend-lake.vercel.app/",
  },
  {
    ...
    github: "https://github.com/usman684/URLShortener",
    live: "https://tinyurl-frontend-vert.vercel.app/",
  },
  {
    title: "Weather App",
    description:
...
const otherProjects = [
  ...
  },
  {
    title: "Amazon Clone",
    description:
      "Feature-rich e-commerce platform with Stripe integration, complex state management, and cloud functions.",
    ...
    <section id="projects" className="py-24 bg-white/1">
      <div className="container mx-auto px-6 mb-20">
        ...
        <p className="text-gray-500 text-lg">
          My personal favorites and most complex builds.
        </p>
      </div>
              ...
              <div className="relative aspect-video rounded-3xl overflow-hidden glass p-2">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-6">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-white hover:text-brand-purple transition-all hover:scale-110"
                  >
                    <Github size={32} />
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-white hover:text-brand-blue transition-all hover:scale-110"
                  >
            ...
            <div className="flex-1 space-y-6">
              <div className="flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-[10px] font-bold uppercase tracking-widest text-brand-purple py-1 px-3 rounded-full bg-brand-purple/10 border border-brand-purple/20"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex gap-6 pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-white font-bold hover:text-brand-purple transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-white font-bold hover:text-brand-blue transition-colors"
                >
      ...
      <div className="container mx-auto px-6">
        ...
        <h2 className="text-3xl font-black mb-12">
          Other <span className="text-gray-500 italic">Creations</span>
        </h2>
